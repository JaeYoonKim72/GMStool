...
parser$add_argument("-x", "--stopx", type = "double", default = 0.2, help = "Stop condition: x is a number corresponding to X percent of the total number of input markers. If the correlation rates of train and validation sets do not improve x times in a row, the marker selection for the corresponding CV is stopped and the results up to that point are returned (Default 0.2)")
