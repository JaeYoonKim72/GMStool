##########
#GMStool v1 for Marker selecion, made by Jae-Yoon Kim and Seongmun Jeong in 2020-09-17.
##########
...
parser$add_argument("-is", "--initial_snps", type = "integer", default = 1, help = "# of initial SNPs to be selected (Default 1)")
...
if (ini_snps <= 0){
  cat(paste0("Error5: the number of initial SNPs must be more than 0."), '\n')
  quit(save = "no")
}
