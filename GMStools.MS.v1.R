...
parser$add_argument("-t", "--test", default = NULL, help = "Test sample list file")
...
parser$add_argument("-a", "--acc", type = "double", default = 0.95, help = "traget correlation rate")
parser$add_argument("-d", "--increment", type = "double", default = 0.00005, help = "Increament of correlation rate in marker selection")
...
parser$add_argument("-gpu", "--GPU_usage", default = FALSE, help = "If TRUE, RRB is calculated using GPU (Only available in Linux)")
