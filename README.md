...
## 3. Run
  #### 3-1. Preparation phase
         - GMStool requires essentially three input files, genotype, phenotype, and GWAS result files. 
         ...
         - "Preset file" means a list of markers that must be selected, and consists of a column with the marker names. The name of the column must be exist.
